...
CONFIG_PUERTOS:
    bsf TRISB, 0, c ; ((PORTB) and 0FFh), 0, a (((PORTB) and 0FFh), 0, a), ((PORTB) and 0FFh), 1, a (((PORTB) and 0FFh), 1, a), ((PORTB) and 0FFh), 2, a (((PORTB) and 0FFh), 2, a) Entradas
    bsf TRISB, 1, c
    bsf TRISB, 2, c
    bsf TRISA, 0, c ; ((PORTA) and 0FFh), 0, a (((PORTA) and 0FFh), 0, a) Entrada LM35

    clrf TRISC, c ; PORTC Salidas (((PORTC) and 0FFh), 0, a: Decenas, ((PORTC) and 0FFh), 1, a: Unidades, ((PORTC) and 0FFh), 2, a: LED Alarma, ((PORTC) and 0FFh), 6, a: Ventilador)
...
CONFIG_ADC:
    movlw 0b00001110 ; ((PORTA) and 0FFh), 0, a analógico, demás digitales
    movwf ADCON1, c
